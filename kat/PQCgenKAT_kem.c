...
main(int argc, char *argv[])
{
    ...
    sprintf(fn_rsp, "PQCkemKAT_%ld.rsp", CRYPTO_SECRETKEYBYTES);
    ...
    do {
        ...
        if ( (ret_val = nistpqc.keypair(pk, sk)) != 0) {
        ...
        if ( (ret_val = nistpqc.enc(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = nistpqc.dec(ss1, ct, sk)) != 0) {
